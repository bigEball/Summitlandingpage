...
export interface LandingPageProps {
  /** Where the demo button points. Defaults to the application's sign-in. */
  demoHref?: string;
  /**
   * Called before navigation. Use it to hand the click to a router. The demo
   * lives in a different deployment from this site, so nothing here passes it —
   * it exists for a host that does have the app on the same origin.
   */
