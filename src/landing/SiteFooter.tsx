    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="mt-4 flex flex-col items-start justify-between gap-3 text-[14px] text-white/60 sm:flex-row sm:items-center">
          ...
          {/* The demo is the application's deployment, not this one, so this is
              a plain anchor off this origin rather than a routed link. */}
          <a href={APP_URL} className="transition-colors duration-300 hover:text-white">
            Demo access
          </a>
        </div>
